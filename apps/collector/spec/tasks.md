...
- 2026-02-24: Completed module-boundary migration: Collector publish path now uses `@rising-intelligence/pipeline/transport`, app-local `src/kafka/` wrappers were removed, shared root imports were migrated to subpaths, and workspace build/lint/tests pass.
